...
export declare type GetDashboardEmbedUrlCommandInput = GetDashboardEmbedUrlRequest;
export declare type GetDashboardEmbedUrlCommandOutput = GetDashboardEmbedUrlResponse & __MetadataBearer;
/**
